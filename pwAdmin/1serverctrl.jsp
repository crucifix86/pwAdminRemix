...
//				fw.close();
		...
		if(request.getParameter("process").compareTo("startserver") == 0)
		{
			...
			try
			{
				...
				fw.write("sleep 3\n");
				fw.write("cd " + pw_server_path + "auth/build; ./authd.sh start &\n");
				fw.write("sleep 3\n");
				...
				//fw.write("cd " + pw_server_path + "glinkd; ./glinkd gamesys.conf 5 >" + pw_server_path + "logs/glink5.log &\n");
				fw.write("sleep 3\n");
				fw.write("cd " + pw_server_path + "gamed; ./gs gs01 >" + pw_server_path + "logs/gs01.log &\n");
				fw.write("sleep 3\n");
				fw.write("cd " + pw_server_path + "gamed; ./gs is62 >" + pw_server_path + "logs/is62.log &\n");
				fw.write("sleep 3\n");
			//	fw.write("cd " + pw_server_path + "gamed; ./gs gs01 is01 is02 is05 is06 is07 is08 is09 is10 is11 is12 is13 is14 is15 is16 is17 is18 is19 is20 is21 is22 is23 is24 is25 is26 is27is28 is29 is31 is32 is33 is34 is35 is37 is38 is39 is40 is41 is43 is44 is48 is50 bg01 bg02 bg03 bg04 bg05 bg06 arena01 arena02 arena03 arena04 >" + pw_server_path + "logs/mapscoll.log &\n");				
				fw.write("sleep 3\n");
				fw.write("rm foo\n");
				fw.write("sleep 3");
				fw.close();
...
fw.write("sync");
	...
	if(item_labels.compareTo("pwi") == 0)
	{
		String[][] m = 
		{
			...
			{"0", "is44", "Nation War 2"},
			{"0", "is45", "Unknown is45 NA?"},
			{"0", "is46", "Unknown is46 NA?"},
